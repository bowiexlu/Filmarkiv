...
if(isset($_POST["submit"])&&$_FILES['Picture']['size'] <= 4000000){
	...
	*/
	...
	include "file:///C|/Users/lu.xue/Downloads/dbconn.php";
	
	$sql = "INSERT INTO tblMovies(Genreid, Movie, Picture, Releasedate, Length) VALUES('$Genreid','$Movie','$fileName','$Releasedate','$Length')";
